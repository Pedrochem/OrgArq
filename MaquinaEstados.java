...
public class MaquinaEstados {
    ...
    private Image imExecutaTipoI = new Image(new FileInputStream("images/executaTipoI.png"));
    ...
    private Image imAcessaMemoriaTipoI = new Image(new FileInputStream("images/acessoMemoriaTipoI.png"));
    ...
    private final String estadoFinal = "fim";
